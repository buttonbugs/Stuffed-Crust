...
#define DEFAULT_ACCEL_MOUNT_RADIUS_CM 2.418         //Radius of accelerometer from center of robot
...
#define DEFAULT_ACCEL_ZERO_G_OFFSET_X 0.5960396039603967f          //Value accelerometer returns with robot at rest (in G) - adjusts for any offset
